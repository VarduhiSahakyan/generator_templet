...
<div id="optGblPage">
	...
	<alternative-display attribute="''currentProfileName''" value="''RCH_REFUSAL_FRAUD''" enabled="''fraud_refusal''" default-fallback="''default_refusal''" ></alternative-display>
