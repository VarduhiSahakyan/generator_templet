...
SET @local = 'de';
UPDATE CustomItem SET value = @textValue WHERE fk_id_customItemSet = @customItemSetREFUSALRCH AND locale = @local AND ordinal = @ordinal AND pageTypes = @refusalPageType;
