...
UPDATE `CustomComponent` SET `value` = '<style>
	...
	@media all and (max-width: 600px) {
		...
		#main-container #code-txt .custom-text {font-family: FrutigerforUBSWeb, sans-serif; font-weight: normal; font-size: 16px; color: #646464; letter-spacing: 0; line-height: 24px;}
	...
	@media all and (max-width: 250px) {
		#main-container { padding-left: 6px;}
		...
		span.col-sm-6.col-xs-6.text-left.padding-left { padding-left: 0px;}
		...
		#main-container .otp-field input { width: 156px; }
		#main-container .row .submit-btn { display: flex; }
		span#info-icon {position: relative;font-size: 0.8em;top: 7px;left: 5px;float: left;margin-right: 7px;}
		#main-container .help-link {width: 29%;text-align: left;}
		#main-container #code-txt .custom-text {font-family: FrutigerforUBSWeb, sans-serif; font-weight: normal; font-size: 16px; color: #646464; letter-spacing: 0; line-height: 24px; margin-right: 3px;}
		span.ng-binding { word-break: break-word; }
	}
</style>
	...
	<div id="content">
		...
		<div class="menu-elements">
			<div class=" col-xs-12 col-sm-4 col-md-4 col-lg-4 padding-0">
				<span id="code-txt" class="col-xs-6 col-sm-5 col-xs-offset-0 col-sm-offset-1 text-right padding-0 code-margin">
					<custom-text custom-text-key="''network_means_pageType_3''"></custom-text>
					<label id = "menu-separator">:</label>
				</span>
				<span class="col-xs-6 col-sm-6 text-left padding-0">
...
UPDATE `CustomComponent` SET `value` = '<style>
	...
	@media all and (max-width: 500px) and (min-width: 440px) {
		#main-container .menu-elements { width: 70%; }
		#main-container #contentBottom { width: 368px; float: right; padding-left: 4%;}
		span#info-icon {position: relative;font-size: 0.8em;top: 7px;left: 5px;float: left;margin-right: 7px;}
		#main-container .help-link { width: 56%;text-align: left;}
	}
	@media all and (max-width: 439px) and (min-width: 391px) {
		#main-container .menu-elements { width: 100%; }
		#main-container #contentBottom { float: left; }
	}
	@media all and (max-width: 390px) and (min-width: 315px){
		#main-container .menu-elements { width: 100%; }
		#main-container #contentBottom { width: 285px; padding-left: 15%;}
		span#info-icon {position: relative;font-size: 0.8em;top: 7px;left: 5px;float: left;margin-right: 7px;}
		#main-container .help-link {width: 33%;text-align: left; padding-left: 3%;}
...
UPDATE `CustomComponent` SET `value` = '<style>
	...
	@media all and (max-width: 390px) {
	  ...
	  @media all and (max-width: 370px) {
		...
		#main-container #contentBottom { width: 350px; float: left}
	}
	@media all and (max-width: 347px) {
		#main-container #message-container {width: 218px; }
		#main-container .ng-isolate-scope .text-right { text-align: right; padding-left: 0px;}
		#main-container .menu-elements { width: auto; }
		.break-word.ng-scope {width: 100%; display: inline-flex;}
		#main-container .col-sm-5 {width: 31%; display: inline-table;}
		#main-container #contentBottom { width: 300px; float: left}
		#accessApp { height: 328px; display: inline-grid; width: inherit; text-align: center; padding-left: 20px; margin-left: 5%;}
	}
	@media all and (max-width: 300px) {
		#accessApp { height: 328px; display: inline-grid; width: 280px; text-align: center; padding-left: 20px; margin-left: 0%;}
	}
	@media all and (max-width: 250px) {
		#main-container {padding-left: 10px; padding-right: 10px;}
		#main-container #pageHeader {padding-left: 0px; }
		#main-container #pageHeaderLeft {padding-left: 0px; }cd
		#main-container #pageHeaderRight {padding-right: 0px; }
		#main-container #message-container {width: 218px; }
		#main-container #content { text-align: left; margin-left: 0em; }
		#main-container .ng-isolate-scope .text-right { text-align: left; padding-left: 0px;}
