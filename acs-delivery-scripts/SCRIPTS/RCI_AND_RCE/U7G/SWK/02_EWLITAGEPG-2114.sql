...
<style>
	...
	div#alternative-layout {width: 40%;float: left;padding-left: 16px;height: 100%;display: flex;align-items: center;}
	div#alternative-layout img.custom-image {max-height: 64px; max-width: 100%}
</style>
<div id="optGblPage">
...
<style>
	...
	@media all and (max-width: 600px) and (min-width: 501px) {
		...
		.paragraph { text-align: center; }
		.paragraphDescription {text-align: center;}
		.leftColumn { display:block; float:none; width:100%; padding-top: 0em; padding-bottom: 0em; }
		.rightColumn { display:block; float:none; width:100%; margin-left:0px; margin-top: 0px; padding: 0px 0px; }
	...
	@media all and (max-width: 390px) {
		...
		.paragraphDescription {text-align: center;}
		.leftColumn { display:block; float:none; width:100%; }
		.rightColumn { display:block; float:none; width:100%; margin-left:0px; margin-top: 5px;}
	}
	@media all and (max-width: 250px) {
		div#green-banner { display: none;}
		.contentRow { font-size: 11px; }
...
<style>
	...
	@media all and (max-width: 1278px) and (min-width: 701px) {
		...
		.paragraph { text-align: left;}
		.paragraphDescription {text-align: left; }
		div#form-controls {display: inline-block;}
		div#switchMeansButtonId { margin-top: 5px; margin-bottom: 5px;}
		#footer { margin-top: 0px; display: inline-block;}
	}
	@media all and (max-width: 700px) and (min-width: 601px) {
		#pageHeader {height: 96px;}
		...
		.paragraphDescription {text-align: left;}
		div#form-controls {display: inline-block; margin-left: 39%;}
		div#switchMeansButtonId { margin-top: 5px; margin-bottom: 5px;}
		#footer { margin-top: 0px; display: inline-block;}
	}
	@media all and (max-width: 600px) and (min-width: 501px) {
	 ...
	 @media all and (max-width: 500px) and (min-width: 481px) {
		...
		div#switchMeansButtonId { margin-top: 0px; margin-bottom: 5px; text-align: center;}
		#validateButton {margin-left: 0em;}
		.refreshDiv { margin-left: 2%;}
		#footer { height: 60px;  margin-top: 0px;  display: inline-block;}
	}
	@media all and (max-width: 480px) {
		h1 { font-size: 16px; }
		div.side-menu div.menu-title { display: inline; }
		...
		.paragraphDescription {text-align: center;}
		.leftColumn { display: block; float: none; width: 100%; padding-bottom: 0em; }
		.rightColumn { display: block; float: none; width: 100%; margin-left: 0px; margin-top: 10px; padding: 0px 10px;}
		#switchMeansButtonId { display: block; margin-left: auto; margin-right: auto; margin-bottom: 5px;}
		#validateButton { display: block; width: 180px; margin-left: auto; margin-right: auto;}
		#validateButton button { width: 100%; }
		#footer { margin-top: 0px;  display: inline-block;}
	}
	...
	@media all and (max-width: 250px) {
		...
		.leftColumn { display: block; float: none; width: 100%; padding-top: 2px; }
		.rightColumn { margin-top: 0px; }
		#switchMeansButtonId { display: block; width: 220px; margin-left: auto; margin-right: auto; padding-top: 2px; }
		.btn { font-size: 12px; }
		#footer { height: 90px; }
		#cancelButton button { height: 35px; width: 90%;}
		#helpButton button { height: 35px; min-width: 1rem;}
		#cancelButton button custom-text { vertical-align: 10px;}
		#helpButton button custom-text { vertical-align: 10px;}
		div#footer { height: 100px; }
...
<style>
	...
	@media all and (max-width: 480px) {
		...
		.paragraphDescription {text-align: center;}
		.leftColumn { display: block; float: none; width: 100%; padding-bottom: 0em; }
		.rightColumn { display: block; float: none; width: 100%; margin-left: 0px; margin-top: 10px; padding: 0 10px;}
		#otp-form { display: block; width: 200px; margin-left: auto; margin-right: auto; }
		#otp-form input { width: 100%; padding: 0px; }
		div#otp-fields { width: 100%; }
		#validateButton { display: block; width: 180px; margin-left: auto; margin-right: auto;}
...
<style>
	...
	@media screen and (max-width: 250px) {
		div#help-contents {margin-top: 0px; margin-bottom: 0px;}
		p { margin: 0 0 0px;}
		#helpCloseButton > button {	margin-top: 0px; }
	}
</style>
<div id="help-page">
