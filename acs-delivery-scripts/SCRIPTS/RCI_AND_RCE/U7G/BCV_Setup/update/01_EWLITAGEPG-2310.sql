...
SET @BankB = 'BCV';
SET @BankUB = 'Banque Cantonale Vaudoise';
...
<style>
	...
	@media all and (max-width: 250px) {
		...
		#cancelButton button { height: 35px; width: 200px;}
...
<style>
	...
	@media all and (max-width: 250px) {
		...
		.leftColumn { display: block; float: none; width: 100%; padding-top: 2px; }
		.rightColumn { margin-top: 0px; }
		#switchMeansButtonId { display: block; width: 230px; margin-left: auto; margin-right: auto; padding-top: 2px; }
