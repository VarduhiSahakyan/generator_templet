...
UPDATE `OPERAND` SET `condition_id` = @comerzCobrandsRuleConditionId_AMOUNT_MAX WHERE `condition_id` = @comerzCobrandsRuleConditionId_SCORE_LOW AND `name` = 'THRESHOLD_SCORE';

DELETE FROM RULE_CONDITION WHERE rule_id = @comerzCobrandsMaxLowId and name = 'C0_SCORE_LOW';

UPDATE `OPERAND` SET `condition_id` = @comerzCobrandsRuleConditionId_AMOUNT_SUM WHERE `condition_id` = @comerzCobrandsRuleConditionId_SCORE_SUM_LOW AND `name` = 'THRESHOLD_SCORE';

DELETE FROM RULE_CONDITION WHERE rule_id = @comerzCobrandsSumLowId and name = 'C0_SCORE_LOW';
...
UPDATE `OPERAND` SET `condition_id` = @comerzAgRuleConditionId_AMOUNT_MAX WHERE `condition_id` = @comerzAgRuleConditionId_SCORE_LOW AND `name` = 'THRESHOLD_SCORE';

DELETE FROM RULE_CONDITION WHERE rule_id = @comerzAgMaxLowId and name = 'C0_SCORE_LOW';

UPDATE `OPERAND` SET `condition_id` = @comerzAgRuleConditionId_AMOUNT_SUM WHERE `condition_id` = @comerzAgRuleConditionId_SCORE_SUM_LOW AND `name` = 'THRESHOLD_SCORE';

DELETE FROM RULE_CONDITION WHERE rule_id = @comerzAgSumLowId and name = 'C0_SCORE_LOW';