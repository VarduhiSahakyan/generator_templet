...
set @pageLayoutIdOTP = (select id from `CustomPageLayout` where `pageType` = 'OTP_FORM_PAGE' and DESCRIPTION = 'OTP Form Page (Commerzbank Cobrands)');
...
</div>' where fk_id_layout = @pageLayoutIdOTP;


set @pageLayoutIdOTP = (select id from `CustomPageLayout` where `pageType` = 'INFO_REFUSAL_PAGE' and DESCRIPTION = 'INFO Refusal Page (Commerzbank Cobrands)');
...
set @pageLayoutIdOTP = (select id from `CustomPageLayout` where `pageType` = 'REFUSAL_PAGE' and DESCRIPTION = 'Refusal Page (Commerzbank Cobrands)');
...
set @pageLayoutIdOTP = (select id from `CustomPageLayout` where `pageType` = 'FAILURE_PAGE' and DESCRIPTION = 'Failure Page (Commerzbank Cobrands)');
