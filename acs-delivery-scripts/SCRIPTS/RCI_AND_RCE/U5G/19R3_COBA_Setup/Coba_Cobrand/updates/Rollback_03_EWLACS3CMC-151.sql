...
SET @ordinal = 14;
update CustomItem set value = 'Die Zahlung wurde abgebrochen.'
where fk_id_customItemSet = @customItemSetPASSWORD and pageTypes = @currentPageType and ordinal = @ordinal;

SET @ordinal = 15;
update CustomItem set value = 'Starten Sie den Bezahlvorgang erneut, wenn Sie die Zahlung durchführen möchten.'
where fk_id_customItemSet = @customItemSetPASSWORD and pageTypes = @currentPageType and ordinal = @ordinal;
