...
UPDATE CustomItem SET value = 'Weiter' WHERE fk_id_customItemSet = @customItemSetPassword AND pageTypes = @otpFormPageType AND ordinal = 42;
...
DELETE FROM CustomItem WHERE fk_id_customItemSet = @customItemSetPassword AND pageTypes = @pageTypeHelp AND ordinal IN (1, 2, 3, 11);
...
UPDATE CustomItem SET value = 'Weiter' WHERE fk_id_customItemSet = @customItemSetPhotoTan AND pageTypes = @otpFormPageType	AND ordinal = 42;
...
DELETE FROM CustomItem WHERE fk_id_customItemSet = @customItemSetPhotoTan AND pageTypes = @pageTypeHelp AND ordinal IN (1, 2, 3, 11);
...
DELETE FROM CustomItem WHERE fk_id_customItemSet = @mobileAppCustomItemSet AND pageTypes = @pageTypeHelp AND ordinal IN (1, 2, 3, 11);
...
SET @pageLayoutId = (SELECT id FROM CustomPageLayout WHERE description = 'Help Page (Commerzbank AG)' AND pageType = 'HELP_PAGE');
SET @profileSetId = (SELECT id FROM ProfileSet WHERE name = 'PS_COZ_01');

DELETE FROM CustomPageLayout_ProfileSet WHERE customPageLayout_id = @pageLayoutId AND profileSet_id = @profileSetId;

SET @pageLayoutIdHelp = (SELECT id FROM `CustomPageLayout` WHERE `DESCRIPTION` = 'Help Page (Commerzbank AG)');
DELETE FROM CustomComponent WHERE fk_id_layout = @pageLayoutIdHelp;

DELETE FROM CustomPageLayout WHERE id = @pageLayoutId;