...
SET @text1 = 'The SMS authentication will no longer be supported and therefore will be switched off. To continue using
...
SET @locale = 'de';
SET @text1 = 'Die Authentifizierung per SMS wird in Kürze nicht mehr unterstützt und daher abgeschaltet. Um Mastercard®
