...
UPDATE `U5G_ACS_BO`.`CustomItem` SET `value`= '' WHERE fk_id_customItemSet IN (@customItemSetSMSChoiceId, @customItemSetSMSId) AND pageTypes = 'APP_VIEW' AND ordinal = 155;