...
SET @ordinal = 153;
update CustomItem set value = 'Freigabegeräte auswählen:'
where fk_id_customItemSet = @customItemSetId and ordinal = @ordinal and pageTypes = @pageType;

set @customPageLayoutDesc_appView = 'DEVICE_Choice_App_View (ING)';
set @pageType = 'MOBILE_APP_EXT_APP_VIEW_DEVICE_SELECT';

set @idAppViewPage = (select id from `CustomPageLayout` where pageType = @pageType and description = @customPageLayoutDesc_appView);
		...
		<div class="scrollbar col-md-12">
			...
			<div class="acs-purchase-context col-md-12 challenge-processing-zone">
				<div class="row">
					...
					<div class="row">
						<div class="col-md-12">
							<label class="acs-challengeInfoLabel" for="challenge-html-data-entry" data-cy="CHALLENGE_INFO_LABEL">
