...
UPDATE CustomItem SET VALUE = '<b>Gerät</b>' WHERE pageTypes = 'CHOICE_PAGE' AND fk_id_customItemSet in (@customItemSetId) AND ordinal = 3 and DTYPE='T' AND name ='VISA_OTP_FORM_PAGE_3_de';


INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`, `name`, `updateState`, `locale`, `ordinal`, `pageTypes`, `value`, `fk_id_network`, `fk_id_image`, `fk_id_customItemSet`)
  	SELECT 'T', 'InitPhase', NOW(), NULL, NULL, NULL,'VISA_MOBILE_APP_CHOICE_PAGE_18_de' , 'PUSHED_TO_CONFIG', @locale, 18, 'CHOICE_PAGE', 'Bitte Freigabegerät auswählen',NULL, NULL, @customItemSetId FROM `Network` n WHERE  n.id in (@networkVISA);
