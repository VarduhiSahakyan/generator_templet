...
INSERT INTO `BinRange` (`activateState`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('ACTIVATED', @createdBy, NOW(), NULL, NULL, NULL, NULL, 'PUSHED_TO_CONFIG', FALSE, NOW(), '4546172000', 16, FALSE, NULL, '4546172999', FALSE, @ProfileSetId, @MaestroVID, NULL);

INSERT INTO `BinRange_SubIssuer` (`id_binRange`, `id_subIssuer`)
  SELECT b.id, s.id
  FROM BinRange b, SubIssuer s
  WHERE b.lowerBound='4546172000' AND b.upperBound='4546172999' AND b.fk_id_profileSet=@ProfileSetId
