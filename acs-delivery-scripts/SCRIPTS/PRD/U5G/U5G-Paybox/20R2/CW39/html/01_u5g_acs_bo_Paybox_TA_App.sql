...
( NULL, 'MOBILE_APP_APP_VIEW', 'TA_App_View (Paybox)');
	...
	<div class="acs-container">
			...
			<div class="acs-footer col-md-12 information-zone">
				<div class="row">
					...
					<div class="acs-footer-icon col-md-2">
						<a tacontainer="body" data-toggle="popover" data-placement="top"
						   data-trigger="focus" data-contenbindex="0" role="button"
						   data-t="network_means_pageType_159">
							<i class="fa fa-plus"></i>
						</a>
					</div>
				</div>
...
select cpl.id, ps.id
  from CustomPageLayout cpl, ProfileSet ps
    where cpl.description = 'TA_App_View (Paybox)' and pageType ='MOBILE_APP_APP_VIEW'and ps.name = 'PS_PAYBOX_01';
