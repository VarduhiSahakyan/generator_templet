...
( NULL, 'MOBILE_APP_EXT_APP_VIEW', 'MOBILE_APP_EXT_App_View (OP)');
...
select cpl.id, ps.id
  from CustomPageLayout cpl, ProfileSet ps
    where cpl.description = 'MOBILE_APP_EXT_App_View (OP)' and pageType ='MOBILE_APP_EXT_APP_VIEW'and ps.name = 'PS_20000_SMS_OP';
