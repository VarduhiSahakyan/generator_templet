...
('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName,'_',@authentMeanPassword,'_',@pageTypeHelp,'_3'), @updateState,
 'de', 3, @pageTypeHelp, '<I>Sie können sich auf der Internetseite www.commerzbank.de/sicher-einkaufen unter „Jetzt registrieren“ das dafür erforderliche Einmal-Passwort bei uns anfordern.</I> ', @MaestroVID, NULL, @customItemSetPassword),
...
('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName,'_',@authentMeanSMS,'_',@pageTypeHelp,'_3'), @updateState,
 'de', 3, @pageTypeHelp, '<I>Sie können sich auf der Internetseite www.commerzbank.de/sicher-einkaufen unter „Jetzt registrieren“ das dafür erforderliche Einmal-Passwort bei uns anfordern.</I>', @MaestroVID, NULL, @customItemSetSMS),
