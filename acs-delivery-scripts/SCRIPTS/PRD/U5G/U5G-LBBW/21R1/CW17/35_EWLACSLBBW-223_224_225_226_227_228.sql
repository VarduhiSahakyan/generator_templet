...
UPDATE `CustomItem` SET `value` = 'Sie haben das BW&#8209;Secure Passwort vergessen? Vergeben Sie online ein neues Passwort auf der Seite:<br><a href="https://sicheres-bezahlen.bw-bank.de/" target="_blank">https://sicheres-bezahlen.bw-bank.de/</a>'
...
UPDATE `CustomItem` SET `value` = 'Ihre Mobilfunknummer hat sich geändert? Registrieren Sie die neue Mobilfunknummer direkt auf der Seite:<br><a href="https://sicheres-bezahlen.bw-bank.de/" target="_blank">https://sicheres-bezahlen.bw-bank.de/</a>'
...
UPDATE `CustomItem` SET `value` = 'Bitte warten Sie ein paar Sekunden, Ihre Eingaben werden geprüft.' WHERE
...
UPDATE `CustomItem` SET `value` = 'Das eingegebene Passwort und/oder die mTAN war(en) nicht korrekt.<br>Bitte prüfen Sie die Eingaben und versuchen Sie es erneut.<br><b>Sie haben noch @trialsLeft Versuche.</b>' WHERE
		`fk_id_customItemSet` in (@customItemSetPassword,@customItemSetSMSNormal) AND
		`pageTypes` = @currentPageType AND
		`ordinal` = 29;
