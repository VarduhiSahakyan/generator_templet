...
INSERT INTO `ProfileSet_Rule` (`id_profileSet`, `id_rule`)
	...
	WHERE ps.`name` = CONCAT('PS_', @BankUB, '_01') AND r.`id` IN (@ruleRefusalFraud, @ruleRBAAccept, @ruleRBADecline, @ruleMobileAppnormal, @ruleSMSFallBack, @ruleRefusalDefault, @ruleINFOnormal, @ruleUNDEFINED);
