...
SET @appViewPageDescription = 'App_View OTP_SMS_PWD_OTP (SWISSKEY)';
...
SET @pageType = 'OTP_SMS_APP_VIEW';
SET @appViewPageDescription = 'App_View OTP_SMS (SWISSQUOTE)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
UPDATE `CustomComponent` SET `value` = '<style>
	...
	input#challenge-resend-submit,
	input#challenge-submit {
		width: 100%;
		margin-bottom: 0.5em;
		text-transform: uppercase;
	}
...
SET @appViewPageDescription = 'App_View OTP_SMS (SWISSKEY)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'OTP_SMS_EXT_MESSAGE_APP_VIEW';
SET @appViewPageDescription = 'App_View OTP_SMS (UBS)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'OTP_SMS_EXT_MESSAGE_APP_VIEW';
SET @appViewPageDescription = 'App_View OTP_SMS (RAIFFEISEN)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'OTP_SMS_EXT_MESSAGE_APP_VIEW';
SET @appViewPageDescription = 'App_View OTP_SMS_EXT (ZKB)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'OTP_SMS_EXT_MESSAGE_APP_VIEW';
SET @appViewPageDescription = 'App_View OTP_SMS_EXT (BCV)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = 'App_View EXT_PASSWORD (SWISSKEY)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = 'App_View PASSWORD (SWISSKEY)';
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
