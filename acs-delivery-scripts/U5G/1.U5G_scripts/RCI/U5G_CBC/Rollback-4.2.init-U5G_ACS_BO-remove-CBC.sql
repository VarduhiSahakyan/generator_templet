-- deletes the whole etup for OP Bank (Issuer Code 00070)
...
-- 1. delete from
set @id_issuer = (SELECT ID from Issuer where CODE = '00070');
...
delete from Image where name in ('China Bank Corporation');
