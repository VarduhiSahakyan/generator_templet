...
VALUES (NULL,'MESSAGE_BANNER', CONCAT('Message Banner (',@BankB, ')')),
     ...
     (NULL,'PASSWORD_OTP_FORM_PAGE',CONCAT('Password OTP Form Page (',@BankB, ')')),
...
INSERT INTO `CustomComponent` (`type`, `value`, `fk_id_layout`)
  VALUES( 'div','<style>
	...
	@media all and (max-width: 480px) {
		...
		side-menu .text-left { padding-right: 5px; padding-left: 5px; text-align: start;}
		side-menu .text-right { padding-right: 5px; padding-left: 5px; text-align: right;}
		div#footer { margin-top: 7px; margin-bottom : 10px; padding-top: 6px; padding-bottom: 6px; }
		#pageHeader { height: 70px; }
	}
	@media all and (max-width: 347px) {
		h1 { font-size:14px; }
...
INSERT INTO `CustomComponent` (`type`, `value`, `fk_id_layout`)
	...
	div#footer #switchId button span:before {
		content:\' \';
	}
	div#footer #switchId > button > span.fa-check-square {
		display:none;
	}
	...
	div#footer #validateButton > button > span.fa-check-square {
		display:none;
	}
	div#footer {
		padding-top: 12px;
...
INSERT INTO `CustomComponent` (`type`, `value`, `fk_id_layout`)
	...
	div#footer #validateButton button span:before {
		content:'''';
	}
	div#footer #cancelButton button span:before {
		content:'''';
...
VALUES
  ...
  (@createdBy, NOW(), CONCAT('customitemset_', @BankUB, '_TA_Choice'), NULL, NULL,
    CONCAT('customitemset_', @BankUB, '_TA_Choice'), 'PUSHED_TO_CONFIG', 'DEPLOYED_IN_PRODUCTION', 1, NULL, NULL, @subIssuerID),
  ...
  (@createdBy, NOW(), CONCAT('customitemset_', @BankUB, '_TA_Current'), NULL, NULL,
    CONCAT('customitemset_', @BankUB, '_TA'), 'PUSHED_TO_CONFIG', 'DEPLOYED_IN_PRODUCTION', 1, NULL, NULL, @subIssuerID),
...
INSERT INTO `Profile` (`createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`, `name`,
  ...
  (@createdBy, NOW(), CONCAT(@Bank_B,'RBA_DECLINE'), NULL, NULL, CONCAT(@BankUB,'_DECLINE'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '6:(:DIGIT:1)', @authMeanACCEPT, @customItemSetRBADECLINE, NULL, NULL, @subIssuerID),
  (@createdBy, NOW(), CONCAT(@Bank_B,'TA (CHOICE)'), NULL, NULL, CONCAT(@BankUB,'_TA_01'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '6:(:DIGIT:1)', @authMeanMobileApp, @customItemSetTAChoice, NULL, NULL, @subIssuerID),
  (@createdBy, NOW(), CONCAT(@Bank_B,'OTP_SMS (CHOICE)'), NULL, NULL, CONCAT(@BankUB,'_SMS_01'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '6:(:DIGIT:1)', @authMeanOTPsms, @customItemSetSMSChoice, NULL, NULL, @subIssuerID),
  ...
  (@createdBy, NOW(), CONCAT(@Bank_B,'PASSWORD (NORMAL)'), NULL, NULL, CONCAT(@BankUB,'_PASSWORD_01'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '10:(:ALPHA_MAJ:1)&(:ALPHA_MIN:1)&(:DIGIT:1)', @authMeanPassword, @customItemSetPassword, NULL, NULL, @subIssuerID),
  (@createdBy, NOW(), CONCAT(@Bank_B,'TA (NORMAL)'), NULL, NULL, CONCAT(@BankUB,'_TA_02'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '6:(:DIGIT:1)', @authMeanMobileApp, @customItemSetTA, NULL, NULL, @subIssuerID),
  (@createdBy, NOW(), CONCAT(@Bank_B,'OTP_SMS (NORMAL)'), NULL, NULL, CONCAT(@BankUB,'_SMS_02'), 'PUSHED_TO_CONFIG', 2, '^[^OIi]*$', '6:(:DIGIT:1)', @authMeanOTPsms, @customItemSetSMS, NULL, NULL, @subIssuerID);
...
INSERT INTO `Rule` (`createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`, `name`,
  ...
  (@createdBy, NOW(), 'REFUSAL_MISSING_AUTHENTMEANS', NULL, NULL, 'REFUSAL (MISSING AUTHENTMEANS)', 'PUSHED_TO_CONFIG', 2, @profileUndefinedRefusal),
  (@createdBy, NOW(), 'RBA_ACCEPT', NULL, NULL, 'NONE (ACCEPT)', 'PUSHED_TO_CONFIG', 3, @profileRBAACCEPT),
  (@createdBy, NOW(), 'RBA_DECLINE', NULL, NULL, 'REFUSAL (DECLINE)', 'PUSHED_TO_CONFIG', 4, @profileRBADECLINE),
  (@createdBy, NOW(), 'TA_AVAILABLE_CHOICE', NULL, NULL, 'TA (CHOICE)', 'PUSHED_TO_CONFIG', 5, @profileTAChoice),
  ...
  (@createdBy, NOW(), 'PASSWORD_AVAILABLE_NORMAL', NULL, NULL, 'PASSWORD (NORMAL)', 'PUSHED_TO_CONFIG', 10, @profilePassword),
  (@createdBy, NOW(), 'TA_AVAILABLE_NORMAL', NULL, NULL, 'TA (NORMAL)', 'PUSHED_TO_CONFIG', 9, @profileTA),
  (@createdBy, NOW(), 'SMS_AVAILABLE_NORMAL', NULL, NULL, 'OTP_SMS (NORMAL)', 'PUSHED_TO_CONFIG', 11, @profileSMS),
  (@createdBy, NOW(), 'REFUSAL_DEFAULT', NULL, NULL, 'REFUSAL (DEFAULT)', 'PUSHED_TO_CONFIG', 12, @profileRefusal);
...
INSERT INTO `RuleCondition` (`createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`, `name`,
  ...
  (@createdBy, NOW(), NULL, NULL, NULL, CONCAT('C1_P_',@BankUB,'_01_TA_CHOICE'), 'PUSHED_TO_CONFIG', @ruleTAchoice),
  (@createdBy, NOW(), NULL, NULL, NULL, CONCAT('C1_P_',@BankUB,'_02_TA_CHOICE'), 'PUSHED_TO_CONFIG', @ruleTAchoice),
  (@createdBy, NOW(), NULL, NULL, NULL, CONCAT('C1_P_',@BankUB,'_01_OTP_SMS_CHOICE'), 'PUSHED_TO_CONFIG', @ruleSMSnormalchoice),
  ...
  (@createdBy, NOW(), NULL, NULL, NULL, CONCAT('C1_P_',@BankUB,'_01_TA_NORMAL'), 'PUSHED_TO_CONFIG', @ruleTAnormal),
...
INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_MISSING_AUTHENTMEAN') AND (ts.`transactionStatusType`='KNOWN_PHONE_NUMBER' AND ts.`reversed`=TRUE);

INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_TA_CHOICE') AND (ts.`transactionStatusType`='USER_CHOICE_ALLOWED' AND ts.`reversed`=FALSE);

INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_02_TA_CHOICE') AND (ts.`transactionStatusType`='USER_CHOICE_ALLOWED' AND ts.`reversed`=FALSE);
...
INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_OTP_SMS_CHOICE') AND (ts.`transactionStatusType`='PHONE_NUMBER_IN_NEGATIVE_LIST' AND ts.`reversed`=TRUE);

INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_OTP_SMS_CHOICE') AND (ts.`transactionStatusType`='KNOWN_PHONE_NUMBER' AND ts.`reversed`=FALSE);
...
INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_MEANS_CHOICE_NORMAL') AND (ts.`transactionStatusType`='USER_CHOICE_ALLOWED' AND ts.`reversed`=FALSE);

INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_MEANS_CHOICE_NORMAL') AND (ts.`transactionStatusType`='PHONE_NUMBER_IN_NEGATIVE_LIST' AND ts.`reversed`=TRUE);

INSERT INTO `Condition_TransactionStatuses` (`id_condition`, `id_transactionStatuses`)
  SELECT c.id, ts.id FROM `RuleCondition` c, `TransactionStatuses` ts
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_MEANS_CHOICE_NORMAL') AND (ts.`transactionStatusType`='KNOWN_PHONE_NUMBER' AND ts.`reversed`=FALSE);
...
INSERT INTO `Condition_MeansProcessStatuses` (`id_condition`, `id_meansProcessStatuses`)
  ...
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_01_TA_CHOICE')
...
INSERT INTO `Condition_MeansProcessStatuses` (`id_condition`, `id_meansProcessStatuses`)
  SELECT c.id, mps.id FROM `RuleCondition` c, `MeansProcessStatuses` mps
  WHERE c.`name`= CONCAT('C1_P_',@BankUB,'_02_TA_CHOICE')
    AND mps.`fk_id_authentMean`=@authMeanMobileApp AND (mps.`meansProcessStatusType`='MEANS_AVAILABLE' AND mps.`reversed`=FALSE);
...
INSERT INTO `ProfileSet_Rule` (`id_profileSet`, `id_rule`)
    ...
    WHERE ps.`name` = CONCAT('PS_',@BankUB,'_01') AND r.`id` IN (@ruleRefusalFraud, @ruleRBAAccept, @ruleRBADecline, @ruleUndefinedRefusal, @ruleTAchoice, @ruleSMSnormalchoice, @ruleAuthentMeansChoice, @rulePasswordnormal, @ruleTAnormal, @ruleSMSnormal, @ruleRefusalDefault);
