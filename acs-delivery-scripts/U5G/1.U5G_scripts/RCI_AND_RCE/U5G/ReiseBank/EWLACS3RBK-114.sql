...
SET @text = 'The SMS authentication will no longer be supported and therefore will be switched off.
	To continue using Mastercard® Identity Check™ and to be able to make payments on the Internet please register for the \
	RBMC Secure App. For further information please click on the Help button';
...
SET @locale = 'de';
SET @text = 'Die Authentifizierung per SMS wird in Kürze nicht mehr unterstützt und daher abgeschaltet.
 Um Mastercard® Identity Check™ weiterhin zu nutzen und Zahlungen im Internet durchführen zu können, registrieren Sie sich bitte umgehend
	für die RBMC Secure App. Für weitere Informationen klicken Sie bitte auf den Hilfe-Button.';
