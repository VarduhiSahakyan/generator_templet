USE U5G_ACS_BO;
SET @BankB = 'EWB';
SET @value = '<div id="messageBanner">
	<span class="fa fa-info-circle" id="info-icon"></span>
	<custom-text custom-text-key="$parent.heading" id="headingTxt"></custom-text>
	<custom-text custom-text-key="$parent.message" id="message"></custom-text>
</div>
<style>
	span#info-icon {
		position: absolute;
	...
	@media all and (max-width: 600px) {
		...
		#headingTxt { font-size: 20px; padding: 4px 1px 1px 1px;}
		span#message { width: 80%; font-size: 15px;}
	}
	...
	@media all and (max-width: 480px) {
		...
		h3 { font-size: 18px; margin-top: 0px; margin-bottom: 0px; }
		#headingTxt { font-size: 18px; padding: 4px 1px 1px 1px;}
		span#message { width: 80%; font-size: 13px;}
	}
	@media screen and (max-width: 390px) {
		#message-controls .btn { font-size: 12px; }
		h3 { font-size: 16px; margin-top: 0px; margin-bottom: 0px; }
		#headingTxt { font-size: 16px; padding: 4px 1px 1px 1px;}
		span#message { width: 80%; font-size: 11px;}
	}
	@media screen and (max-width: 320px) {
		#message-controls .btn { font-size: 10px; }
		h3 { font-size: 11px; margin-top: 0px; margin-bottom: 0px; }
		#headingTxt { font-size: 11px; padding: 4px 1px 1px 1px;}
		span#message { width: 80%; font-size: 8px;}
	}
	.spinner {
		position: relative;
		display: block;
