...
( NULL, 'MOBILE_APP_EXT_APP_VIEW', 'MOBILE_APP_EXT_App_View (Consors)');
...
select cpl.id, ps.id
  from CustomPageLayout cpl, ProfileSet ps
    where cpl.description = 'MOBILE_APP_EXT_App_View (Consors)' and pageType ='MOBILE_APP_EXT_APP_VIEW'and ps.name = 'PS_16900_01';
