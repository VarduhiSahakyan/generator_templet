...
SET @appViewPageDescription = CONCAT('TA_App_View (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = CONCAT('App_View (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = CONCAT('LANGUAGE_Choice_App_View (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = CONCAT('DEVICE_Choice_App_View (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'UNDEFINED_APP_VIEW_MEAN_SELECT';
...
SET @pageType = 'MOBILE_APP_EXT_APP_VIEW';
SET @appViewPageDescription = CONCAT('App_View pushTAN (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @appViewPageDescription = CONCAT('KBA_APP_VIEW (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
SET @pageType = 'OTP_SMS_EXT_MESSAGE_APP_VIEW_DEVICE_SELECT';
...
<body>
    <div class="acs-container">
			...
			<span id="content">network_means_pageType_157 </span>
					...
					<div class="acs-footer-icon col-md-2">
						<input type=checkbox id="show1" class="div-right">
						<label for="show1"><a data-tooltip="network_means_pageType_159">
						<i class="fa fa-plus"></i></a></label>
						<span id="content">network_means_pageType_159 </span>
					</div>
				</div>
			</div>
		</div>
...
SET @pageType = 'MOBILE_APP_APP_VIEW';
SET @appViewPageDescription = CONCAT('MOBILE_APP_APP_VIEW (', @BankB ,')');
SET @idAppViewPage=(SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @appViewPageDescription);
...
UPDATE `CustomComponent` SET `value` = '<style>
    @import url(//db.onlinewebfonts.com/c/a458519e2421b2cc647e8bc90d27ee0c?family=BNPP+Sans);
    @font-face {font-family: "BNPPSans"; src:
    url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.eot");
    src: url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.eot?#iefix") format("embedded-opentype"),
    url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.woff2") format("woff2"),
    url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.woff") format("woff"),
    url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.ttf") format("truetype"),
    url("//db.onlinewebfonts.com/t/a458519e2421b2cc647e8bc90d27ee0c.svg#BNPP Sans") format("svg"); }
	.acs-container {
		padding: 0em;
