...
SET @ordinal = 152;
update CustomItem set value = 'Geben Sie Ihr BW-Secure Passwort ein, um den Vorgang zu bestätigen. Diese Information wird dem Händler nicht mitgeteilt.
...
SET @ordinal = 151;
update CustomItem set value = 'BW-Secure mTAN eingeben'
where fk_id_customItemSet = @customItemSet_SMS  and pageTypes = @pageType  and ordinal = @ordinal;

SET @ordinal = 152;
update CustomItem set value = 'Geben Sie die gerade per SMS erhaltene mTAN in das Feld "mTAN" ein, um den Vorgang zu bestätigen. Diese Information wird dem Händler nicht mitgeteilt.'
where fk_id_customItemSet = @customItemSet_SMS  and pageTypes = @pageType  and ordinal = @ordinal;

SET @ordinal = 157;
update CustomItem set value = 'Ihre Kreditkartenzahlung muss in der BW-Secure App mit 3D-Secure bestätigt werden.
