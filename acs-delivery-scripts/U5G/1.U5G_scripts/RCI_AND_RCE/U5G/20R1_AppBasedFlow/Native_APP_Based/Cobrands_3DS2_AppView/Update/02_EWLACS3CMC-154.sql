...
SET @ordinal = 157;
update CustomItem set value = 'Haben Sie Ihr 3-D Secure Passwort vergessen?\n\nSie können sich auf der Internetseite www.commerzbank.de/sicher-einkaufen unter „Jetzt registrieren“ das davor erforderliche Einmal-Passwort bei uns anfordern.'
where fk_id_customItemSet = @customItemSetPASSWORD and pageTypes = @pageType and ordinal = @ordinal;
...
SET @ordinal = 157;
update CustomItem set value = 'Die mobileTAN senden wir Ihnen per SMS.\n\nMöchten Sie Ihre Mobilnummer aktualisieren? Sie können sich auf der Internetseite www.commerzbank.de/sicher-einkaufen unter „Jetzt registrieren“ das davor erforderliche Einmal-Passwort bei uns anfordern.'
where fk_id_customItemSet = @customItemSetSMS and pageTypes = @pageType and ordinal = @ordinal;
