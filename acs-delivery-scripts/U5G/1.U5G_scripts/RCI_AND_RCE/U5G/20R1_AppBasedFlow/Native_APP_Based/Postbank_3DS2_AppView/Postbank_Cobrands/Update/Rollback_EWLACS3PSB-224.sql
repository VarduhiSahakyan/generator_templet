...
SET @customPageLayoutDesc_AppView = 'MOBILE_APP_APP_VIEW (FBK)';
...
SET @customPageLayoutDesc_AppView = 'SMS_App_View (FBK)';
...
SET @customPageLayoutDesc_AppView = 'Choice_App_View (FBK)';
