...
INSERT INTO `CustomComponent` (`type`, `value`, `fk_id_layout`)
  VALUES( 'div', '<div id="main-container">
...
-- Authentication cancelled
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@networkName, '_', @currentAuthentMean, '_', @currentPageType, '_15'), @updateState,
   @locale, 15, @currentPageType, 'Starten Sie den Bezahlungsvorgang erneut, wenn Sie die Zahlung abschließen möchten.', @networkId, NULL, @customItemSetMobileApp),
...
-- Authentication successful
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@networkName, '_', @currentAuthentMean, '_', @currentPageType, '_27'), @updateState,
   @locale, 27, @currentPageType, 'Sie wurden erfolgreich authentifizier und werden automatisch zum Händler weitergeleitet.', @networkId, NULL, @customItemSetMobileApp),
...
-- Session expired
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@networkName, '_', @currentAuthentMean, '_', @currentPageType, '_31'), @updateState,
   @locale, 31, @currentPageType, 'Sie haben einige Zeit keine Eingabe vorgenommen, daher wurde die Zahlung abgebrochen. Starten Sie die Bezahlungsvorgang erneut, wenn Sie die Zahlung abschließen möchten.', @networkId, NULL, @customItemSetMobileApp),
...
-- technical error
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@networkName, '_', @currentAuthentMean, '_', @currentPageType, '_33'), @updateState,
   @locale, 33, @currentPageType, 'Es ist ein technischer Fehler aufgetreten. Wir arbeiten schnellmöglich an der Behebung des Problems. Bei Fragen wenden Sie sich bitte telefonisch an unsere Kundenbetreuung unter 01406 – 708 25 00.', @networkId, NULL, @customItemSetMobileApp);
...
-- authentication failure
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@networkName, '_', @currentAuthentMean, '_', @currentPageType, '_17'), @updateState,
   @locale, 17, @currentPageType, 'Aus Sicherheitsgründen haben wir Ihren Zugang zu Visa Secure und dem comdirect Online-Banking gesperrt. Für Fragen zur Entsperrung wenden Sie sich bitte telefonisch an unsere Kundenbetreuung unter 01406 – 708 25 00.', @networkId, NULL, @customItemSetMobileApp),
