...
DELETE FROM `CustomItem` WHERE fk_id_customItemSet = @customItemSetChipTan_id AND
							   ordinal = 9 AND
							   `pageTypes` = @pageType;

DELETE FROM `CustomItem` WHERE fk_id_customItemSet = @customItemSetChipTanChoice_id AND
							   ordinal = 9 AND
							   `pageTypes` = @pageType;
