...
('T', 'InitPhase', NOW(), NULL, NULL, NULL, CONCAT(@networkVISA,'_',@currentAuthentMean,'_',@currentPageType,'_4'), 'PUSHED_TO_CONFIG',
 'de', 4, @currentPageType, '@challenge1', NULL, NULL, @customItemSetId);
