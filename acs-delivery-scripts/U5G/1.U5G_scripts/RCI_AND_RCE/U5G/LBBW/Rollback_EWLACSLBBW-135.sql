...
SET @BankUB = 'Landesbank Baden-Württemberg';

SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('OTP Form Page for ', @BankUB ));
...
UPDATE CustomComponent SET value = '<style>
	...
	@media all and (max-width: 390px) {
		h1 {font-size: 14px;}
		div.side-menu div.menu-title { display: inline; }
		div#optGblPage { font-size: 12px; overflow: hidden; }
	...
	@media all and (max-width: 309px) {
		div#optGblPage { font-size: 10px; overflow: hidden; }
		.leftColumn { display: block; float: none; width: 100%; padding-bottom: 220px;}
	...
	@media all and (max-width: 250px) {
		div#optGblPage { font-size: 08px; overflow: hidden; }
...
SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('Polling Page for ', @BankUB ));
...
UPDATE CustomComponent SET value = '<style>
	...
	@media all and (max-width: 347px) {
		div#optGblPage { font-size: 12px; overflow: hidden; }
		.paragraph { text-align: center;}
		.leftColumn { display: block; float: none; width: 107%; padding-bottom: 150px;}
		.rightColumn { display: block; float: none; width: 100%; margin-left: 0px; text-align: center; margin-top: -75px; }
		#issuerLogo { max-height: 32px; max-width: 100%; }
		#networkLogo {max-height: 42px; max-width: 100%; }
	}
	@media all and (max-width: 309px) {
		div#optGblPage { font-size: 10px; overflow: hidden; }
		.rightColumn { display: block; float: none; width: 100%; margin-left: 0px; text-align: center; margin-top: -85px; }
		#issuerLogo { max-height: 32px; max-width: 100%; }
		#networkLogo {max-height: 42px; max-width: 100%; }
	}
	@media all and (max-width: 250px) {
