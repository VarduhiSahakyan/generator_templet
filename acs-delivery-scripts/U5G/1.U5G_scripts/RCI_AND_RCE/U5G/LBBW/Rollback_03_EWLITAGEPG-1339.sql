...
SET @ordinal = 11;
update CustomItem set value = '<b>Informationen zur Zahlung</b>'
...
SET @layoutId = (SELECT id FROM `CustomPageLayout` WHERE `pageType`= @pageType and `description` = @pageLayoutDescriptionPassword);
...
name = CONCAT(@NetworkVName,'_',@currentAuthentMean,'_',@currentPageType,'_3');
