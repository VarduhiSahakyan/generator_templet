...
SET @pageLayoutId = (select id from `CustomPageLayout` where `pageType` = 'EXT_PASSWORD_OTP_FORM_PAGE' and DESCRIPTION = 'EXT Password OTP Form Page (BNP_WM)');
...
SET @pageLayoutId = (select id from `CustomPageLayout` where `pageType` = 'PHOTO_TAN_OTP_FORM_PAGE' and DESCRIPTION = 'Photo Tan Page (BNP_WM)');
