USE U5G_ACS_BO;
SET @BankUB = 'Commerzbank Cobrands';

SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('OTP Form Page (', @BankUB ,')'));
...
SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('Password OTP Form Page (', @BankUB ,')'));
UPDATE CustomComponent SET value = '
<style>
...
SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('Refusal Page (', @BankUB ,')'));
UPDATE CustomComponent SET value = '
<style>
	div#optGblPage {
		font-family: Arial,bold;
...
SET @layoutId=(SELECT id FROM `CustomPageLayout` WHERE DESCRIPTION = CONCAT('Failure Page (', @BankUB ,')'));
UPDATE CustomComponent SET value = '
<style>
	div#optGblPage {
		font-family: Arial,bold;
