...
UPDATE SubIssuer SET 3DS2AdditionalInfo = ' { "VISA": { "operatorId": "10066894", "dsKeyAlias": "dsvisa_call_alias_cert_01" }, "MASTERCARD": { "operatorId": "ACS-V210-EQUENSWORLDLINE-34926", "dsKeyAlias": "dsmc_call_alias_cert_01" } }'
...
UPDATE CryptoConfig SET protocolTwo = '{
  "cavvKeyIndicator": "02",
  "cipherKeyIdentifier": "EC09250002314145535F434F4E534F52535F00",
  "acsIdForCrypto": "08",
  "binKeyIdentifier": "1",
  "hubAESKey": "01",
  ...
  "cardNetworkIdentifierMap": {
    "VISA": "240925000231434156565F436F6E736F727300"
  },
  "acsSignedContentCertificateKeyMap": {
    "VISA": "ED09250002314B544F525F434C455F54454303"
  },
  "acsSignedContentCertificateMap": {
    "VISA": {
      ...
      "signingCertificateExpiryDate": "26/08/2021",
