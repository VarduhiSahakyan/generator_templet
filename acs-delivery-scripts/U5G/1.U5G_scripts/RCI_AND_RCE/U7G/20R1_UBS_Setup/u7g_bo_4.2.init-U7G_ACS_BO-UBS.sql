				...
				<div id="contentBottom" class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                   ...
                   <div class="resendTan">
                    ...
                    <div id="footer">
                        <div class="help-area">
                            <div class="help-link">
                                <span class="fa fa-angle-right"></span> <help help-label="''network_means_pageType_41''" id="helpButton" class="helpButtonClass"></help>
                            </div>
                        </div>
                    </div>
                </div>
		...
		<div id="content">
				...
				<div id="contentBottom" class=" col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div id="footer">
                        <div class="help-area">
                            <div class="help-link">
                                <span class="fa fa-angle-right"> <help help-label="''network_means_pageType_41''" id="helpButton" class="helpButtonClass"></help>
                            </div>
                        </div>
                    </div>
                </div>
...
INSERT INTO `CustomComponent` (`type`, `value`, `fk_id_layout`)
  ...
  <div id="help-page">
	...
	<div class="row">
		<div class="help-link">
			 <help-close-button help-close-label="''network_means_HELP_PAGE_43''" id="helpCloseButton"></help-close-button>
		</div>
	</div>
</div>
</div>
<style>
    ...
    #main-container #helpCloseButton div {
        display: inline;
    }
    #main-container #helpCloseButton button {
        border-style: none;
        padding: 0px;
        text-align: center;
        color:#007099;
...
INSERT INTO `Profile` (`createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`, `name`,
  ...
  (@createdBy, NOW(), 'MOBILE_APP_EXT', NULL, NULL, CONCAT(@BankUB,'_APP_01'), 'PUSHED_TO_CONFIG', 3,'6:(:DIGIT:1)','^[^OIi]*$', @authentMeansMobileApp, @customItemSetMOBILEAPP, NULL, NULL, @subIssuerID),
