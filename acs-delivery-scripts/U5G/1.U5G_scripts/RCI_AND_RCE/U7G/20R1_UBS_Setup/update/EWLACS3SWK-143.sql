...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
	...
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypePolling, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypePolling, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypePolling, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypePolling, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetMOBILEAPP),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypeOTP, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypeOTP, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypeOTP, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypeOTP, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypeFailure, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypeFailure, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypeFailure, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypeFailure, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypeRefusal, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypeRefusal, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypeRefusal, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypeRefusal, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypeRefusal, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypeRefusal, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypeRefusal, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypeRefusal, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetRefusal),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'de', 175, @pageTypeRefusal, @txt_back_to_shop_DE, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'en', 175, @pageTypeRefusal, @txt_back_to_shop_EN, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'fr', 175, @pageTypeRefusal, @txt_back_to_shop_FR, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_175'), 'PUSHED_TO_CONFIG',
	 'it', 175, @pageTypeRefusal, @txt_back_to_shop_IT, @MaestroVID, NULL, @customItemSetINFORefusal),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypePolling, @txt_close_DE, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypePolling, @txt_close_EN, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypePolling, @txt_close_FR, @MaestroVID, NULL, @customItemSetMOBILEAPP),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanMobile, '_', @pageTypePolling, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypePolling, @txt_close_IT, @MaestroVID, NULL, @customItemSetMOBILEAPP),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypeOTP, @txt_close_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypeOTP, @txt_close_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypeOTP, @txt_close_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeOTP, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypeOTP, @txt_close_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypeFailure, @txt_close_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypeFailure, @txt_close_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypeFailure, @txt_close_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeFailure, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypeFailure, @txt_close_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypeRefusal, @txt_close_DE, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypeRefusal, @txt_close_EN, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypeRefusal, @txt_close_FR, @MaestroVID, NULL, @customItemSetSMS),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanSMS, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypeRefusal, @txt_close_IT, @MaestroVID, NULL, @customItemSetSMS),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypeRefusal, @txt_close_DE, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypeRefusal, @txt_close_EN, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypeRefusal, @txt_close_FR, @MaestroVID, NULL, @customItemSetRefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypeRefusal, @txt_close_IT, @MaestroVID, NULL, @customItemSetRefusal),

	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'de', 174, @pageTypeRefusal, @txt_close_DE, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'en', 174, @pageTypeRefusal, @txt_close_EN, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'fr', 174, @pageTypeRefusal, @txt_close_FR, @MaestroVID, NULL, @customItemSetINFORefusal),
	('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MaestroVName, '_', @authentMeanRefusal, '_', @pageTypeRefusal, '_174'), 'PUSHED_TO_CONFIG',
	 'it', 174, @pageTypeRefusal, @txt_close_IT, @MaestroVID, NULL, @customItemSetINFORefusal);
