...
set @customPageLayoutDesc_appView = 'App_View OTP_SMS (SWISSKEY)';
...
set @customPageLayoutDesc_appView = 'App_View OTP_SMS_PWD_OTP (SWISSKEY)';
...
set @customPageLayoutDesc_appView = 'App_View TA (UBS)';
