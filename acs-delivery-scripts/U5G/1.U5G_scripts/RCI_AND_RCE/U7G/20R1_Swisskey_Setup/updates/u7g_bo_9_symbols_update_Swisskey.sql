...
SET @layoutId = (SELECT id
                 FROM CustomPageLayout
                 WHERE DESCRIPTION like CONCAT('Refusal Page (', @BankB, ')%'));
SET @layout = '
<style>
	div#optGblPage {
		font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;
...
SET @layoutId = (SELECT id
                 FROM CustomPageLayout
                 WHERE DESCRIPTION like CONCAT('Failure Page (', @BankB, ')%'));
SET @layout = '
<style>
	div#optGblPage {
		font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;
...
SET @layoutId = (SELECT id
                 FROM CustomPageLayout
                 WHERE DESCRIPTION like CONCAT('Help Page (', @BankB, ')%'));
SET @layout = '<div id="help-page">
