...
div#alternative-layout {width: 50%;float: left;padding-left: 16px;height: 100%;display: flex;align-items: center;}
...
<div id="optGblPage">
	<div id="pageHeader" ng-style="style" class="ng-scope">
        ...
        <div class="defaultContent" ng-style="style" class="ng-scope" style="display: none;">
            DEFAULT_CONTENT
        </div>
	</div>
