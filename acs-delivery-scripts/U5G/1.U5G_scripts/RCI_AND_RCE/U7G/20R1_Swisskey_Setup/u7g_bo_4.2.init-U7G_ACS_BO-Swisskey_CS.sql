...
INSERT INTO `AuthentMeans` (createdBy, creationDate, description, lastUpdateBy, lastUpdateDate, name, updateState)
  SELECT 'InitPhase', sysdate(), 'OTP_SMS_EXT_MESSAGE', NULL, NULL, 'OTP_SMS_EXT_MESSAGE', 'PUSHED_TO_CONFIG' FROM dual
...
SET @availableAuthMeans = 'REFUSAL|OTP_SMS_EXT_MESSAGE|MOBILE_APP';
