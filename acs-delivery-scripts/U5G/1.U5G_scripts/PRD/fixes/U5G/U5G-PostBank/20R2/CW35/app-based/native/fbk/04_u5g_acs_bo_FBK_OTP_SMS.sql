...
SET @customItemSetId = (SELECT id FROM CustomItemSet WHERE name = 'customitemset_18502_PB_SMS');
...
SET @customItemSetChoice = (SELECT id FROM CustomItemSet WHERE name = 'customitemset_18502_PB_SMS_Choice');
