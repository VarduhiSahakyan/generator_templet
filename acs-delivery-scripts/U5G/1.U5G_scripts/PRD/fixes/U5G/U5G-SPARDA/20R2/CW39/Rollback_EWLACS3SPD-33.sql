...
UPDATE CustomItem SET VALUE = '<b>Kundennummer:</b> @challenge1' WHERE pageTypes = @currentPageType AND fk_id_customItemSet in (@customItemSetId) AND ordinal = 3 and DTYPE='T';