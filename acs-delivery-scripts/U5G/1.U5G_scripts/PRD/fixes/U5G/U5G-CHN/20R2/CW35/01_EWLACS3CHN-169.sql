...
SET @customPageLayoutDesc_appView = 'App_View (CBC)';
	   ...
	   <body>
			 <div class="acs-container col-md-12">
					...
					<div class="acs-header row branding-zone">
						   ...
						   <div class="col-md-6">
								  <img class="align-right" src="network_means_pageType_254" alt="Card network image" data-cy="CARD_NETWORK_IMAGE"/>
						   </div>
					</div>
					<!-- ACS BODY | Challenge/Processing zone -->
					<div class="acs-purchase-context col-md-12 challenge-processing-zone">
						   <div class="col-md-12">
								  <div class="acs-challengeInfoHeader" data-cy="CHALLENGE_INFO_HEADER">
										network_means_pageType_151
								  </div>
								  <div class="col-md-12">
										<div class="acs-challengeInfoText" id="acs-challenge-info-text" data-cy="CHALLENGE_INFO_TEXT">
