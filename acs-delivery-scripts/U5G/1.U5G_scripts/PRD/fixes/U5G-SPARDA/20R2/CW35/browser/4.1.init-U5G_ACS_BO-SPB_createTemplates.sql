...
VALUES (NULL,'MESSAGE_BANNER', CONCAT('Message Banner (', @bankName, ')')),
       ...
       (NULL,'MOBILE_APP_EXT_CHOICE_PAGE', CONCAT('Polling Choice Page (', @bankName, ')')),
...
VALUES( 'div','<div id="messageBanner">
...
SET @layoutId = (SELECT id FROM `CustomPageLayout` WHERE `DESCRIPTION` like CONCAT('Polling Choice Page (', @bankName, ')') );
