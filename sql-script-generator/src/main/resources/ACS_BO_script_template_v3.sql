USE `${databaseACS_BO}`; 
# Test multiple key ${createdBy} ${issuerCode}
...
*/
[[bin###START_1###_lowerBound]]set @binRangeLowerBound###VALUE###='${bin###VALUE###_lowerBound}';
[[bin###START_1###_upperBound]]set @binRangeUpperBound###VALUE###='${bin###VALUE###_upperBound}';

[[bin1_lowerBound]]INSERT INTO `BinRange` (`activateState`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
[[bin1_lowerBound]]                        `name`, `updateState`, `immediateActivation`, `activationDate`, `lowerBound`, `panLength`,
[[bin1_lowerBound]]                        `sharedBinRange`, `updateDSDate`, `upperBound`, `toExport`, `fk_id_profileSet`, `fk_id_network`,
[[bin1_lowerBound]]                        `coBrandedCardNetwork`) VALUES
[[bin1_lowerBound]]  ('ACTIVATED', @createdBy, NOW(), NULL, NULL, NULL, NULL, @updateState, TRUE, NOW(), @binRangeLowerBound1, 16, FALSE, NULL, @binRangeUpperBound1, FALSE, @ProfileSet, @MastercardID, NULL)
[[bin###START_2###_lowerBound]]  ,('ACTIVATED', @createdBy, NOW(), NULL, NULL, NULL, NULL, @updateState, TRUE, NOW(), @binRangeLowerBound###VALUE###, 16, FALSE, NULL, @binRangeUpperBound###VALUE###, FALSE, @ProfileSet, @MastercardID, NULL)
[[bin1_lowerBound]];
