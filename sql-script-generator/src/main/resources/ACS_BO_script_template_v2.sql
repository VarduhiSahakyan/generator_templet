...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1'), @updateState,
         'de', 1, @currentPageType, '<b>3D Secure Authentifizierung nicht möglich</b>', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_5'), @updateState,
         'de', 5, @currentPageType, 'Zahlungsfreigabe nicht möglich', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'de', 22, @currentPageType, '3D Secure Authentifizierung nicht ausgeführt - Karte ist nicht für 3D Secure registriert', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'de', 23, @currentPageType, 'Die Zahlung konnte nicht ausgeführt werden, da Ihre Karte nicht für 3D-Secure-Zahlungen registriert ist. Sollten Sie den Kauf fortsetzen wollen, bitten wir Sie, Ihre Karte gemäß der Anleitung Ihrer Bank entsprechend zu registrieren.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'de', 32, @currentPageType, '3D Secure Authentifizierung nicht ausgeführt - Technischer Fehler', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'de', 33, @currentPageType, 'Bei der Bearbeitung Ihrer Anfrage ist leider ein technischer Fehler aufgetreten. Bitte versuchen Sie es später noch einmal.', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_100'), @updateState,
         'de', 100, 'ALL', 'Händler', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
		 'de', 230, @currentPageType, 'Aus Sicherheitsgründen wurde Ihre Zahlung nicht ausgeführt. Ihre Karte wurde nicht belastet.', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_175'), @updateState,
         'de', 175,@currentPageType, 'Zurück zum Online-Shop', @MastercardID, NULL, @customItemSetREFUSAL);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'de', 2, @helpPage, 'Aus Sicherheitsgründen müssen Sie sich an das Payment Card Service Helpdesk wenden, um die Änderung Ihrer Mobiltelefonnummer zu beantragen.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_3'), @updateState,
         'de', 3, @helpPage, 'Für diese und alle anderen Fragen zu Ihrer Karte erreichen Sie den Helpdesk unter +41 58 721 93 93.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_16'), @updateState,
         'de', 16, @currentPageType, 'Zahlung nicht ausgeführt - Karte ist nicht für 3D Secure registriert', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'de', 17, @currentPageType, 'Die Zahlung konnte nicht ausgeführt werden, da Ihre Karte nicht für 3D Secure Zahlungen registriert ist. Sollten Sie den Kauf fortsetzen wollen, bitten wir Sie Ihre Karte gemäss der Anleitung Ihrer Bank entsprechend zu registrieren.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'fr', 22, @currentPageType, 'Authentification 3D Secure non effectué - La carte n''est pas enregistrée pour 3D Secure', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'fr', 23, @currentPageType, 'Le paiement n''as pas pu être effectué car votre carte n''est pas enregistrée pour les paiements 3D Secure. Si vous souhaitez poursuivre l''achat, nous vous prions d''enregistrer votre carte conformément aux instructions de votre banque.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'fr', 32, @currentPageType, 'Authentification 3D Secure non effectuée - Erreur technique', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'fr', 33, @currentPageType, 'Malheureusement une erreur technique est survenue lors du traitement de votre demande. Veuillez réessayer plus tard.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_41'), @updateState,
         'fr', 41, @currentPageType, 'Aide', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_100'), @updateState,
         'fr', 100, 'ALL', 'Commerçant', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_103'), @updateState,
         'fr', 103, 'ALL', 'Numéro de carte', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_104'), @updateState,
         'fr', 104, 'ALL', 'Numéro de téléphone mobile', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
		 'fr', 220, @currentPageType, 'L''authentification 3D Secure a échoué', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
		 'fr', 230, @currentPageType, 'Pour des raisons de sécurité, votre paiement n''a pas été traité. Votre carte n''a pas été débitée.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'fr', 2, @helpPage, 'Pour des raisons de sécurité, vous devez contacter le Payment Card Service Helpdesk afin de demander la modification de votre numéro de téléphone portable.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_3'), @updateState,
         'fr', 3, @helpPage, 'Pour ce faire et pour tout autre problème, vous pouvez contacter le HelpDesk au numéro +41 58 721 93 93.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_16'), @updateState,
         'fr', 16, @currentPageType, 'Le paiement n''a pas été effectué - La carte n''est pas enregistrée pour 3D Secure', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'fr', 17, @currentPageType, 'Le paiement n''as pas pu être effectué car votre carte n''est pas enregistrée pour les paiements 3D Secure. Si vous souhaitez poursuivre l''achat, nous vous prions d''enregistrer votre carte conformément aux instructions de votre banque.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
                          ...
                          `fk_id_network`, `fk_id_image`, `fk_id_customItemSet`) VALUES
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1'), @updateState,
         'it', 1, @currentPageType, '<b>L''autenticazione 3D Secure non è possibile</b>', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'it', 22, @currentPageType, 'Autenticazione 3D Secure non eseguita  - La carta non è registrata per 3D Secure', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'it', 23, @currentPageType, 'Non è stato possibile effettuare il pagamento perché la sua carta non è registrata per i pagamenti 3D Secure. Se desidera continuare l’acquisto, la preghiamo di registrare la sua carta secondo le istruzioni della sua banca.', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'it', 32, @currentPageType, 'Autenticazione 3D Secure non eseguita - Errore tecnico', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'it', 33, @currentPageType, 'Spiacenti. Si è verificato un errore tecnico durante l’elaborazione della sua richiesta. La preghiamo di riprovare più tardi.', @MastercardID, NULL, @customItemSetREFUSAL),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
		 'it', 230, @currentPageType, 'Per motivi di sicurezza, il tuo pagamento non è stato elaborato. La tua carta non è stata addebitata.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'it', 2, @helpPage, 'Per motivi di sicurezza, per richiedere la modifica del suo numero di cellulare dovrà contattare il Payment Card Service Helpdesk.', @MastercardID, NULL, @customItemSetREFUSAL),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_16'), @updateState,
         'it', 16, @currentPageType, 'Pagamento non eseguito - La carta non è registrata per 3D Secure', @MastercardID, NULL, @customItemSetREFUSAL),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'it', 17, @currentPageType, 'Non è stato possibile effettuare il pagamento perché la sua carta non è registrata per i pagamenti 3D Secure. Se desidera continuare l’acquisto, la preghiamo di registrare la sua carta secondo le istruzioni della sua banca.', @MastercardID, NULL, @customItemSetREFUSAL),
...
('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1000'), @updateState,
 'de', 1000, @currentPageType, 'Die Zahlung kann nicht ausgeführt werden. Bitte kontaktieren Sie den Payment Card Service Helpdesk unter +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
 ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1000'), @updateState,
 'en', 1000, @currentPageType, 'The payment cannot be processed. Please contact the Payment Card Service Helpdesk on +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1000'), @updateState,
 'it', 1000, @currentPageType, 'La transazione non è andata a buon fine. Si prega di contattare il Payment Card Service Helpdesk al numero +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1000'), @updateState,
...
('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1001'), @updateState,
 'de', 1001, @currentPageType, 'Die Zahlung kann nicht ausgeführt werden. Bitte kontaktieren Sie den Payment Card Service Helpdesk unter +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1001'), @updateState,
 'en', 1001, @currentPageType, 'The payment cannot be processed. Please contact the Payment Card Service Helpdesk on +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1001'), @updateState,
 'it', 1001, @currentPageType, 'La transazione non è andata a buon fine. Si prega di contattare il Payment Card Service Helpdesk al numero +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1001'), @updateState,
 ...
 'de', 1002, @currentPageType, 'Die Zahlung kann nicht ausgeführt werden. Bitte kontaktieren Sie den Payment Card Service Helpdesk unter +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
   ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1002'), @updateState,
 'en', 1002, @currentPageType, 'The payment cannot be processed. Please contact the Payment Card Service Helpdesk on +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1002'), @updateState,
 'it', 1002, @currentPageType, 'La transazione non è andata a buon fine. Si prega di contattare il Payment Card Service Helpdesk al numero +41 58 721 93 93.', @MastercardID, NULL, @customItemSetRefusalMissing),
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1002'), @updateState,
...
VALUES ('T', @createdBy, NOW(), NULL, NULL, NULL, 'OTP_SMS_MESSAGE_BODY', @updateState, 'de', 0, 'MESSAGE_BODY',
        'Ihr Authentifizierungscode lautet @otp für Ihren Kauf von @amount bei @merchant mit Karte @maskedPan, am @formattedDate.', @MastercardID, NULL, @customItemSetSMS);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_12'), @updateState,
         'de', 12, @currentPageType, '3D Secure Authentifizierung wird geprüft', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_13'), @updateState,
         'de', 13, @currentPageType, 'Bitte haben Sie einen Moment Geduld. Wir prüfen Ihre Zahlungsfreigabe und somit die Authentifikation für die gewünschte Zahlung.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_15'), @updateState,
         'de', 15, @currentPageType, 'Die Zahlung wurde abgebrochen und Ihre Karte nicht belastet. Sofern Sie den Kaufprozess trotzdem fortsetzen möchten, starten Sie den Zahlungsversuch bitte erneut.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'de', 23, @currentPageType, 'Sie haben 3 Mal einen ungültigen Authentifizierungscode eingegeben. 3D Secure wurde für Ihre Karte gesperrt und die Zahlung wurde nicht ausgeführt.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_27'), @updateState,
         'de', 27, @currentPageType, 'Sie haben die Zahlung erfolgreich freigegeben und werden automatisch zum Händler weitergeleitet.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_28'), @updateState,
         'de', 28, @currentPageType, 'Ungültiger Authentifizierungscode', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_29'), @updateState,
         'de', 29, @currentPageType, 'Der von Ihnen eingegebene Ungültiger Authentifizierungscode ist ungültig. Die Zahlung wurde nicht ausgeführt und Ihre Karte wurde nicht belastet. Sofern Sie den Kauf fortsetzen wollen, versuchen Sie es erneut.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_30'), @updateState,
         'de', 30, @currentPageType, 'Zahlung nicht ausgeführt - Sitzung abgelaufen', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_31'), @updateState,
         'de', 31, @currentPageType, 'Ihre Sitzung ist nach einer längeren Inaktivität abgelaufen. Aus Sicherheitsgründen wurde Ihr Zahlungsvorgang deshalb abgebrochen. Bitte kehren Sie zum Online-Shop zurück und starten Sie den Zahlungsprozess erneut, sofern Sie die Zahlung tätigen wollen.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'de', 32, @currentPageType, 'Zahlung nicht ausgeführt - Technischer Fehler', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'de', 33, @currentPageType, 'Auf Grund eines technischen Fehlers konnte die Zahlung nicht ausgeführt werden und Ihre Karte wurde nicht belastet. Sollten Sie die den Kauf fortsetzen wollen, bitten wir Sie es erneut zu versuchen.', @MastercardID, NULL, @customItemSetSMS),
...
('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_34'), @updateState,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_35'), @updateState,
         'de', 35, @currentPageType, 'Bitte haben Sie einen kleinen Moment Geduld. In Kürze erhalten Sie einen neuen Authentifizierungscode an Ihre Mobiltelefonnummer.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_42'), @updateState,
         'de', 42, @currentPageType, 'Bestätigen', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_100'), @updateState,
         'de', 100, 'ALL', 'Händler', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_175'), @updateState,
         'de', 175, @currentPageType, 'Zurück zum Online-Shop', @MastercardID, NULL, @customItemSetSMS);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'de', 2, @currentPageType, 'Aus Sicherheitsgründen müssen Sie sich an das Payment Card Service Helpdesk wenden, um die Änderung Ihrer Mobiltelefonnummer zu beantragen.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_3'), @updateState,
         'de', 3, @currentPageType, 'Für diese und alle anderen Fragen zu Ihrer Karte erreichen Sie den Helpdesk unter +41 58 721 93 93.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_174'), @updateState,
         'de', 174, @currentPageType, 'Hilfe schließen', @MastercardID, NULL, @customItemSetSMS);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'de', 17, @currentPageType, 'Sie haben 3 Mal einen ungültigen Authentifizierungscode eingegeben. 3D Secure wurde für Ihre Karte gesperrt und die Zahlung wurde nicht ausgeführt.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
                          ...
                          `fk_id_network`, `fk_id_image`, `fk_id_customItemSet`) VALUES
 ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1'), @updateState,
         'de', 1, @currentPageType, '<b>Zahlungsfreigabe nicht möglich</b>', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_2'), @updateState,
         'de', 2, @currentPageType, 'Leider konnten wir Ihre Anfrage nicht ausführen, da wir keine Freigabe-Methode (SMS oder App) für Ihre Karte gefunden haben. ', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_3'), @updateState,
         'de', 3, @currentPageType, 'Bitte hinterlegen Sie für Ihre Karte eine entsprechende Freigabe-Methode im Registrierungsportal gemäss der Anleitung Ihrer Bank. ', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_11'), @updateState,
         'de', 11, @currentPageType, '<b>Informationen zur Zahlung</b>', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'de', 22, @currentPageType, 'Zahlung nicht ausgeführt - Karte ist nicht für 3D Secure registriert', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'de', 23, @currentPageType, 'Die Zahlung konnte nicht ausgeführt werden, da Ihre Karte nicht für 3D Secure Zahlungen registriert ist. Sollten Sie den Kauf fortsetzen wollen, bitten wir Sie Ihre Karte gemäss der Anleitung Ihrer Bank entsprechend zu registrieren.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'de', 32, @currentPageType, 'Zahlung nicht ausgeführt - Technischer Fehler', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'de', 33, @currentPageType, 'Auf Grund eines technischen Fehlers konnte die Zahlung nicht ausgeführt werden und Ihre Karte wurde nicht belastet. Sollten Sie den Kauf fortsetzen wollen, bitten wir Sie es erneut zu versuchen.', @MastercardID, NULL, @customItemSetSMS),
...
VALUES ('T', @createdBy, NOW(), NULL, NULL, NULL, 'OTP_SMS_MESSAGE_BODY', @updateState, 'fr', 0, 'MESSAGE_BODY',
        'Votre code d''authentification est le @otp pour votre achat de @amount auprès de @merchant avec votre carte @maskedPan, le @formattedDate.', @MastercardID, NULL, @customItemSetSMS);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_12'), @updateState,
         'fr', 12, @currentPageType, 'L''authentification 3D Secure va être vérifiée', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_13'), @updateState,
         'fr', 13, @currentPageType, 'Merci de patienter. Nous vérifions l''authentification pour le paiement souhaité.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_14'), @updateState,
         'fr', 14, @currentPageType, 'Authentification 3D Secure annulée', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_15'), @updateState,
         'fr', 15, @currentPageType, 'Le paiement a été interrompu et votre carte n’a pas été débitée. Si vous souhaitez malgré tout continuer le processus d’achat, veuillez recommencer la tentative de paiement.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_19'), @updateState,
         'fr', 19, @currentPageType, 'Renvoyer le code SMS', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'fr', 22, @currentPageType, 'L''authentification 3D Secure a échoué', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'fr', 23, @currentPageType, 'Vous avez entré un code d’authentification invalide 3 fois. Le service 3D Secure a été bloqué pour votre carte et le paiement n’a pas été réalisé.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_26'), @updateState,
         'fr', 26, @currentPageType, 'L''autorisation 3D Secure a réussi', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_27'), @updateState,
         'fr', 27, @currentPageType, 'Vous avez réussi à activer le paiement et vous serez redirigé automatiquement vers le site du commerçant.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_28'), @updateState,
         'fr', 28, @currentPageType, 'Code d’authentification incorrect', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_29'), @updateState,
         'fr', 29, @currentPageType, 'Le code d’authentification que vous avez saisi n''est pas correct. Le paiement n''a pas été effectué et votre carte n''a pas été débitée. Si vous voulez continuer l''achat, essayez à nouveau.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_30'), @updateState,
         'fr', 30, @currentPageType, 'Paiement non effectué - La session a expiré', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'fr', 32, @currentPageType, 'Paiement non effectué - Problème technique', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'fr', 33, @currentPageType, 'En raison d’un problème technique, le paiement n’a pas pu être effectué et votre carte n’a pas été débitée. Si vous souhaitez poursuivre l’achat, nous vous prions de bien vouloir essayer à nouveau.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_34'), @updateState,
         'fr', 34, @currentPageType, 'Un nouveau code d‘authentification vient de vous être transmis par SMS.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_35'), @updateState,
         'fr', 35, @currentPageType, 'Veuillez patienter un instant. Vous recevrez d’ici peu un nouveau code d‘authentification sur votre numéro de téléphone mobile.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_100'), @updateState,
         'fr', 100, 'ALL', 'Commerçant', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_103'), @updateState,
         'fr', 103, 'ALL', 'Numéro de carte', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_104'), @updateState,
         'fr', 104, 'ALL', 'Numéro de téléphone mobile', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'fr', 2, @currentPageType, 'Pour des raisons de sécurité, vous devez contacter le Payment Card Service Helpdesk afin de demander la modification de votre numéro de téléphone portable.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_3'), @updateState,
         'fr', 3, @currentPageType, 'Pour ce faire et pour tout autre problème, vous pouvez contacter le HelpDesk au numéro +41 58 721 93 93.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_16'), @updateState,
         'fr', 16, @currentPageType, 'L''authentification 3D Secure a échoué', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'fr', 17, @currentPageType, 'Vous avez entré un code d’authentification invalide 3 fois. Le service 3D Secure a été bloqué pour votre carte et le paiement n’a pas été réalisé.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
 ...
 ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1'), @updateState,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_2'), @updateState,
         'fr', 2, @currentPageType, 'Nous n''avons malheureusement pas pu répondre à votre demande car nous n''avons trouvé aucune méthode d''activation (SMS ou App) pour votre carte. ', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_3'), @updateState,
         'fr', 3, @currentPageType, 'Veuillez consigner une méthode d''activation pour votre carte dans le portail d’inscription, conformément aux instructions de votre banque.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_11'), @updateState,
         'fr', 11, @currentPageType, '<b>Informations concernant le paiement.</b>', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'fr', 22, @currentPageType, 'Le paiement n''a pas été effectué - La carte n''est pas enregistrée pour 3D Secure', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'fr', 23, @currentPageType, 'Le paiement n''as pas pu être effectué car votre carte n''est pas enregistrée pour les paiements 3D Secure. Si vous souhaitez poursuivre l''achat, nous vous prions d''enregistrer votre carte conformément aux instructions de votre banque.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'fr', 32, @currentPageType, 'Paiement non effectué - Problème technique', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'fr', 33, @currentPageType, 'En raison d''une erreur technique, le paiement n''a pas pu être effectué. Si vous souhaitez poursuivre l''achat, nous vous prions de bien vouloir essayer à nouveau.', @MastercardID, NULL, @customItemSetSMS),
...
VALUES ('T', @createdBy, NOW(), NULL, NULL, NULL, 'OTP_SMS_MESSAGE_BODY', @updateState, 'it', 0, 'MESSAGE_BODY',
        'Il suo codice di autenticazione è il @otp per suo acquisto di @amount da @merchant con la sua carta @maskedPan, il @formattedDate.', @MastercardID, NULL, @customItemSetSMS);
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_15'), @updateState,
         'it', 15, @currentPageType, 'Il pagamento è stato annullato e la sua carta non è stata addebitata. Se desidera continuare comunque il processo di acquisto, provi a iniziare di nuovo il pagamento.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'it', 23, @currentPageType, 'Ha inserito 3 volte un codice di autenticazione non valido. Il servizio 3D Secure è stato bloccato per la sua carta; non è stato pertanto possibile effettuare il pagamento.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_26'), @updateState,
         'it', 26, @currentPageType, 'L''autorizzazione 3D Secure è stata eseguita correttamente', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_29'), @updateState,
         'it', 29, @currentPageType, 'Il codice di autenticazione inserito da lei non è valido. Il pagamento non è stato eseguito e la sua carta non è stata addebitata. Se desidera continuare l’acquisto, provi nuovamente.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_30'), @updateState,
         'it', 30, @currentPageType, 'Pagamento non effettuato - Sessione scaduta', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_31'), @updateState,
         'it', 31, @currentPageType, 'La sua sessione è scaduta in seguito a un periodo di inattività prolungato. Il processo di pagamento è stato quindi annullato per motivi di sicurezza. Ritorni al negozio online e inizi di nuovo il processo di pagamento se desidera effettuare il pagamento.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'it', 32, @currentPageType, 'Pagamento non effettuato - Problema tecnico', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'it', 33, @currentPageType, 'Non è stato possibile eseguire il pagamento a causa di un errore tecnico e la sua carta non è stata addebitata. Se desidera continuare l’acquisto, la preghiamo di riprovare nuovamente.', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_35'), @updateState,
         'it', 35, @currentPageType, 'La preghiamo di aspettare. A breve riceverà un nuovo codice di autenticazione sul suo numero di cellulare.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@helpPage,'_2'), @updateState,
         'it', 2, @currentPageType, 'Per motivi di sicurezza, per richiedere la modifica del suo numero di cellulare dovrà contattare il Payment Card Service Helpdesk.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_17'), @updateState,
         'it', 17, @currentPageType, 'Ha inserito 3 volte un codice di autenticazione non valido. Il servizio 3D Secure è stato bloccato per la sua carta; non è stato pertanto possibile effettuare il pagamento.', @MastercardID, NULL, @customItemSetSMS),
...
INSERT INTO `CustomItem` (`DTYPE`, `createdBy`, `creationDate`, `description`, `lastUpdateBy`, `lastUpdateDate`,
 ...
 ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_1'), @updateState,
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_2'), @updateState,
         'it', 2, @currentPageType, 'Purtroppo non siamo riusciti a elaborare la sua richiesta perché non abbiamo trovato un metodo di autenticazione (SMS o app) per la sua carta. ', @MastercardID, NULL, @customItemSetSMS),
  ...
  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_22'), @updateState,
         'it', 22, @currentPageType, 'Pagamento non eseguito - La carta non è registrata per 3D Secure', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_23'), @updateState,
         'it', 23, @currentPageType, 'Non è stato possibile effettuare il pagamento perché la sua carta non è registrata per i pagamenti 3D Secure. Se desidera continuare l’acquisto, la preghiamo di registrare la sua carta secondo le istruzioni della sua banca.', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_32'), @updateState,
         'it', 32, @currentPageType, 'Pagamento non eseguito - Errore tecnico', @MastercardID, NULL, @customItemSetSMS),

  ('T', @createdBy, NOW(), NULL, NULL, NULL, CONCAT(@MastercardName,'_',@currentAuthentMean,'_',@currentPageType,'_33'), @updateState,
         'it', 33, @currentPageType, 'Non è stato possibile eseguire il pagamento a causa di un errore tecnico. Se desidera continuare l’acquisto, la preghiamo di riprovare nuovamente.', @MastercardID, NULL, @customItemSetSMS),
